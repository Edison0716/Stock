...
import com.junlong.framecorelibrary.base.BaseActivity;
 ...
 * @Modified By:
 */
public class BaiduLocationActivity extends BaseMvcActivity {
...
//        }).start();
    ...
    public void showToastMsg(final String msg) {
        BaiduLocationActivity.this.runOnUiThread(new Runnable() {

            @Override
            public void run() {
                Toast.makeText(BaiduLocationActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        BaiduNaviManager.getInstance().init(this, mSDCardPath, APP_FOLDER_NAME, new NaviInitListener() {
            ...
            public void onAuthResult(int status, String msg) {
                ...
                BaiduLocationActivity.this.runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        Toast.makeText(BaiduLocationActivity.this, authinfo, Toast.LENGTH_LONG).show();
                    }
                });
            }
    ...
    private void routeplanToNavi(CoordinateType coType) {
        ...
        if (!hasInitSuccess) {
            Toast.makeText(BaiduLocationActivity.this, "还未初始化!", Toast.LENGTH_SHORT).show();
        }
        // 权限申请
        if (android.os.Build.VERSION.SDK_INT >= 23) {
            // 保证导航功能完备
            if (!hasCompletePhoneAuth()) {
                if (!hasRequestComAuth) {
                    ...
                    Toast.makeText(BaiduLocationActivity.this, "没有完备的权限!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    BaiduNaviManager.NavEventListener eventListerner = (what, arg1, arg2, bundle) -> BNEventHandler.getInstance().handleNaviEvent(what, arg1, arg2, bundle);
    ...
    public class DemoRoutePlanListener implements RoutePlanListener {
        ...
        public void onJumpToNavigator() {
            ...
            Intent intent = new Intent(BaiduLocationActivity.this, BNDemoGuideActivity.class);
        ...
        public void onRoutePlanFailed() {
            // TODO Auto-generated method stub
            Toast.makeText(BaiduLocationActivity.this, "算路失败", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initSetting() {
        ...
        Bundle bundle = new Bundle();
        // 必须设置APPID，否则会静音
        bundle.putString(BNCommonSettingParam.TTS_APP_ID, "10280645");
        ...
        if (requestCode == authBaseRequestCode) {
            for (int ret : grantResults) {
                if (ret == 0) {
                    ...
                    Toast.makeText(BaiduLocationActivity.this, "缺少导航基本的权限!", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            initNavi();
