 ...
 * @Author: 巴黎没有摩天轮Li
 * @Description:
 * @Date: Created in 下午1:25 2017/10/25
 * @Modified By:
 */
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaiduLocationActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(BaiduLocationActivity.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
    ...
    protected void onDestroy() {
        ...
        BaiduLocationActivity.activityList.remove(this);
